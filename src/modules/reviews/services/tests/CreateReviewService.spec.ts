...
describe('Create Review', () => {
  beforeEach(() => {
    ...
    createReview = new CreateReviewService(
  ...
  it('should be able to create a new review with a lv_id', async () => {
  ...
  it('should be able to create a new review with a lv_pos_id', async () => {
    const requirement = await fakeRequirementsRepository.create({
      title: 'Requirement Title',
    });
  ...
  it('should not be able to create a new review with a requirement_id invalid', async () => {
    await expect(
  ...
  it('should not be able to create a new review with a lv_id invalid', async () => {
    const requirement = await fakeRequirementsRepository.create({
      title: 'Requirement Title',
    });
  ...
  it('should not be able to create a new review with a lv_pos_id invalid', async () => {
    const requirement = await fakeRequirementsRepository.create({
      title: 'Requirement Title',
    });
  ...
  it('should not be able to create a new review with a reason_id invalid', async () => {
    const requirement = await fakeRequirementsRepository.create({
      title: 'Requirement Title',
    });
  ...
  it('should not be able to create a new review if it doesnt have lv_id or lv_pos_id', async () => {
    const requirement = await fakeRequirementsRepository.create({
      title: 'Requirement Title',
    });
  ...
  it('should not be able to create a new review with value is invalid', async () => {
    const requirement = await fakeRequirementsRepository.create({
      title: 'Requirement Title',
    });
  ...
  it('should not be able to create a new review if the value is NSA and reason is not sent', async () => {
    const requirement = await fakeRequirementsRepository.create({
      title: 'Requirement Title',
    });
  ...
  it('should not be able to create a new review with a lv_id', async () => {
    const requirement = await fakeRequirementsRepository.create({
      title: 'Requirement Title',
    });
  ...
  it('should not be able to create a new review with a lv_pos_id', async () => {
    const requirement = await fakeRequirementsRepository.create({
      title: 'Requirement Title',
    });
  ...
  it('should not be able to create a new review with a invalid reason_id', async () => {
    const requirement = await fakeRequirementsRepository.create({
      title: 'Requirement Title',
    });
