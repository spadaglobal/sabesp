...
import ListFilteredLvService from '../ListFilteredLvService';
...
let listLv: ListFilteredLvService;
...
describe('ListLv', () => {
  beforeEach(() => {
    ...
    listLv = new ListFilteredLvService(
      fakeLvsRepository,
  ...
  it('should be able to get the cache instead of the database list with user_id', async () => {
    const pagination = jest.spyOn(fakePaginationProvider, 'pagination');
  ...
  it('should be able to get the cache instead of the database list with status', async () => {
    const pagination = jest.spyOn(fakePaginationProvider, 'pagination');
  ...
  it('should be able to get the cache instead of the database list with user_id and status', async () => {
    const pagination = jest.spyOn(fakePaginationProvider, 'pagination');
  ...
  it('should be able to get the cache instead of the database list with group_id and status', async () => {
    const pagination = jest.spyOn(fakePaginationProvider, 'pagination');
